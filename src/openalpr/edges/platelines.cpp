...
namespace alpr
{
 ...
 bilateralFilter(inputImage, smoothed, 7, 45, 45);
...
//previously 66 133 then 50 120
    Canny(smoothed, edges,15,50);

    // Create a mask that is dilated based on the detected characters

//imshow("canny edge",smoothed);
