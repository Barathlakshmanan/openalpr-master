...
//	cout<<"horizontalLines"<<horizontalLines<<endl<<"verticalLines"<<verticalLines<<endl;
...
if(confidence==0)
{
bestLeft.p1.x=0;bestLeft.p1.y=0;bestLeft.p2.x=0;bestLeft.p2.y=inputImage.rows;
bestRight.p1.x=inputImage.cols;bestRight.p1.y=0;bestRight.p2.x=inputImage.cols;bestRight.p2.y=inputImage.rows;
bestTop.p1.x=0;bestTop.p1.y=0;bestTop.p2.x=inputImage.cols;bestTop.p2.y=0;
bestBottom.p1.x=0;bestBottom.p1.y=inputImage.rows;bestBottom.p2.x=inputImage.cols;bestBottom.p2.y=inputImage.rows;
